            ...
            <div class="col-md-3">
              ...
              <div class="box box-primary">
                <div class="box-body box-profile bg-primary" style="padding-top:8px;">
                  ...
                  <a href="/profile_post/<?php echo e($user->id); ?>" class="btn btn-primary btn-block"><b>Trang cá nhân</b></a>
                </div>
                <!-- /.box-body -->
              </div>
              <!-- /.box -->
              ...
              <div class="box box-primary bg-white">
                ...
                <div class="box-body " style="margin-left:10px;">
                  <strong class="text-primary"><i class="fa fa-book margin-r-5"></i> Education</strong>
                  ...
                  <div class="active tab-pane card post" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class=" avatar1" src="<?php echo e(url('/')); ?>/imgs/<?php echo e($data->user->avatar); ?>" alt="user image">
                        <span class="username">
                        <a class="name" href="#"><?php echo e($data->user->name); ?></a>
                          <a href="#" class="pull-right btn-box-tool"></a>
                        </span>
                        <div class="description"><i class="fas fa-globe-americas"></i>Shared publicly - <?php echo e($data->created_at); ?></div>
                      </div>
                      <!-- /.user-block -->
                      <p>
                      ...
                      foreach ($data->likes as $value) {
                       ...
                       ?>
                        <div class="row">
                          <div class="col-md-1">
                            <div id="like<?php echo e($data->id); ?>">
                              ...
                              {
                                ?>
                                <a href="<?php echo e($data->id); ?>/addLike" class="btn btn-primary"><i class="far fa-thumbs-up"></i> <?php echo e($Like); ?>(<?php echo e(count($data->likes)); ?>)</a>
                                <?php }
                            else {
                              ?>
                                <a href="<?php echo e($data->id); ?>/addLike" class="btn btn-danger"><i class="far fa-thumbs-up"></i> <?php echo e($Like); ?>(<?php echo e(count($data->likes)); ?>)</a>
                                <?php }
                            ?>
                          ...
                          <div class="col-md-2" style="margin-left:40px">
                            <a href="post/<?php echo e($data->id); ?>" class="btn btn-primary"> <i class="fas fa-comments"></i>Comments(<?php echo e(count($data->comments)); ?>)</a>
                        ...
                        <form class="form-horizontal" style="margin-top:8px;" action="add_comment/<?php echo e($data->id); ?>/<?php echo e($user->id); ?>" method="POST">
                          ...
                          <div class="form-group margin-bottom-none">
                            <div class="row">
                              <div class="col-sm-8">
                                ...
                                <input type="hidden" name="posts_id" value="<?php echo e($data->id); ?>">
                    ...
                    <script language="javascript">
                      // Hàm thiết lập nội dung cho thẻ div#content
                                                    ...
                                                    {
                                                      console.log('hể');
                                                    	document.getElementById("like" + index).innerHTML = "Liked";  
                                                    }                              
...
<?php /* D:\laravelproject\laravel-blog\resources\views/wall.blade.php */ ?>