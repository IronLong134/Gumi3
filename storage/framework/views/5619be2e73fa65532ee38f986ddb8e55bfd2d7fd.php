                        ...
                        <li class="nav-item active">
                            <a class="nav-link text-white"
                               href="/profile_post/<?php echo e(Auth::user()->id); ?>"><img
                                    class=" avatar1"
                                    src="<?php echo e(url('/')); ?>/imgs/<?php echo e(Auth::user()->avatar); ?>"
                                    alt="user image"> <?php echo e(Auth::user()->name); ?> <span
...
<?php /**PATH D:\git-laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>