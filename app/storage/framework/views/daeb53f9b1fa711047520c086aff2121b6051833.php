                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('register')); ?>">
                            ...
                            <div class="form-group row">
                                <label for="birthday"
                                       class="col-md-4 col-form-label text-md-right"><?php echo e(__('Birthday')); ?></label>
                            ...
                            <div class="form-group row">
                                <label for="personal_id"
                                       class="col-md-4 col-form-label text-md-right"><?php echo e(__('Personal_id')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project\git-laravel\resources\views/auth/register.blade.php ENDPATH**/ ?>