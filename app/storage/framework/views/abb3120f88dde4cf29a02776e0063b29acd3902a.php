                            ...
                            <div class="box box-primary">
                                <div class="box-body box-profile bg-primary" style="padding-top:8px;">
                                    ...
                                    <img class="rounded mx-auto d-block avatar"
                                         src="<?php echo e(url('/')); ?>/imgs/<?php if($user->avatar): ?><?php echo e($user->avatar); ?><?php elseif(!$user->avatar && $user->gender==1): ?><?php echo e("avatar_male.jpg"); ?><?php else: ?><?php echo e("avatar_female.jpg"); ?><?php endif; ?>" alt="User profile picture">
                                        ...
                                        <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="post">
                                                <div class="user-block">
                                                    ...
                                                    <a class="name" href="<?php if($data->user->id==Auth::id(0)): ?>\profile_post\<?php echo e($user->id); ?><?php else: ?>\profile_friend\<?php echo e($data->user->id); ?><?php endif; ?>"><?php echo e($data->user->name); ?></a>
                                                    ...
                                                    <div class="col-md-1">
                                                        <div id="like<?php echo e($data->id); ?>">
                                                            ...
                                                            <a id="like_btn" href="javascript:void(0)"
                                                               class="<?php if($data->checkLike!='liked'): ?>btn btn-primary <?php else: ?> btn btn-danger <?php endif; ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project\git-laravel\resources\views/wall.blade.php ENDPATH**/ ?>