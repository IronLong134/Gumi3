            ...
            <div class="col-md-3">
              ...
              <div class="box box-primary">
                <div class="box-body box-profile bg-primary" style="padding-top:8px;">
                  ...
                  <a href="/profile_post/{{$user->id}}" class="btn btn-primary btn-block"><b>Trang cá nhân</b></a>
                </div>
                <!-- /.box-body -->
              </div>
              <!-- /.box -->
                  ...
                  <div class="active tab-pane card post" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class=" avatar1" src="{{ url('/') }}/imgs/{{$data->user->avatar}}" alt="user image">
                        <span class="username">
                        <a class="name" href="#">{{$data->user->name}}</a>
                          <a href="#" class="pull-right btn-box-tool"></a>
                        </span>
                        <div class="description"><i class="fas fa-globe-americas"></i>Shared publicly - {{$data->created_at}}</div>
                      </div>
                      <!-- /.user-block -->
                      <p>
                        {{$data->content}}
                      ...
                      foreach ($data->likes as $value) {
                       ...
                       ?>
                        <div class="row">
                          <div class="col-md-1">
                            <div id="like{{$data->id}}">
                              ...
                              {
                                ?>
                                <a href="{{$data->id}}/addLike" class="btn btn-primary"><i class="far fa-thumbs-up"></i> {{$Like}}({{count($data->likes)}})</a>
                                <?php }
                            else {
                              ?>
                                <a href="{{$data->id}}/addLike" class="btn btn-danger"><i class="far fa-thumbs-up"></i> {{$Like}}({{count($data->likes)}})</a>
                                <?php }
                            ?>
                          ...
                          <div class="col-md-2" style="margin-left:40px">
                            <a href="post/{{$data->id}}" class="btn btn-primary"> <i class="fas fa-comments"></i>Comments({{count($data->comments)}})</a>
                        ...
                        {{--
                        <div>{{$data->like}}123</div>
                        @foreach ($data->likes as $value)
                        <div>{{$value->posts_id}}</div>
                        <div>{{$value->users_id}}</div>
                        @endforeach --}}

                        <form class="form-horizontal" style="margin-top:8px;" action="add_comment/{{$data->id}}/{{$user->id}}" method="POST">
                          {{csrf_field()}}
